<?php
	...
	if (isset($_POST['submit'])) {
		...
		$query = mysqli_query($con, "insert into appointment(doctorSpecialization,doctorId,
					userId,consultancyFees,appointmentDate,appointmentTime,userStatus,doctorStatus) 
...
<body>
										...
										<div class="panel panel-white">
											...
											<div class="panel-body">
												...
												<form role="form" name="book" method="post">
													...
													<button type="submit" name="submit" class="btn btn-o btn-primary" id="formButton">
														Submit
													</button>
												</form>
											</div>
	...
	<!-- General Bootstrap JavaScript files -->
